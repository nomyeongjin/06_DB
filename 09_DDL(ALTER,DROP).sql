...
ALTER TABLE DEPT_COPY
ADD CONSTRAINT DEPT_COPY_TT_U UNIQUE(DEPT_TITLE);
...
ALTER TABLE DEPT_COPY 
DROP CONSTRAINT DEPT_COPY_TT_U;
...
ALTER TABLE DEPT_COPY 
MODIFY LOCATION_ID CONSTRAINT SYS_C007399 NULL;

ALTER TABLE DEPT_COPY 
MODIFY DEPT_TITLE CONSTRAINT SYS_C007403 NULL;
...
ALTER TABLE DEPT_COPY MO
DIFY DEPT_ID VARCHAR2(4); -- DDL 수행
ROLLBACK;
